...
It looks like our top 6 combinations all have an approximate accuracy of `r rf_accuracies[1,3]`. We'll use the top result, where `mtry` = `rf_accuracies[1,1]`, `ntree` = `rf_accuracies[1,2]`.
